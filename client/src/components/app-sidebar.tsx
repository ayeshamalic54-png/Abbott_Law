...
const roleMenus: Record<string, MenuSection[]> = {
  admin: [
    ...
    },
    {
      ...
      items: [
        { title: "PBC Dashboard", url: "/pbc-dashboard", icon: Building, gradient: "from-emerald-500 to-green-600" },
        { title: "PBC Attendance Report", url: "/pbc/attendance-report", icon: FileText, gradient: "from-teal-500 to-cyan-600" },
      ]
    },
    {
      label: "System",
  ...
  accountant: [
    ...
    },
    {
      ...
      items: [
        ...
        { title: "Daily Reports", url: "/accounts/reports", icon: TrendingUp, gradient: "from-green-500 to-emerald-600" },
        { title: "Financial Summary", url: "/accounts/summary", icon: DollarSign, gradient: "from-purple-500 to-pink-600" },
  ...
  pbc: [
    {
      label: "Overview",
      items: [
        { title: "Dashboard", url: "/", icon: LayoutDashboard, gradient: "from-emerald-500 to-green-600" },
      ]
    },
    {
      label: "Student Attendance",
      items: [
        { title: "Attendance Report", url: "/pbc/attendance-report", icon: FileText, gradient: "from-teal-500 to-cyan-600" },
      ]
    },
  ],
};
