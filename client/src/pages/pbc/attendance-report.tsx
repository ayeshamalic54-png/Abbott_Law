...
export default function PBCAttendanceReport() {
  ...
  // Get LLB programs only for PBC portal
  ...
  const handleExport = () => {
    ...
    a.href = url;
    a.download = `pbc-attendance-report-${selectedProgram}-${selectedDate}.csv`;
    a.click();
    ...
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center justify-between gap-4 print:hidden">
        <div className="flex items-center gap-3">
          <img src={pbcLogo} alt="Pakistan Bar Council" className="h-16 w-16 object-contain" />
          <div>
            <h1 className="text-3xl font-bold text-foreground" data-testid="heading-pbc-attendance-report">
              Pakistan Bar Council - Attendance Report
            </h1>
        ...
        <div className="flex items-center gap-2">
          <Button variant="outline" size="default" onClick={handleExport} data-testid="button-pbc-export">
            <Download className="h-4 w-4 mr-2" />
            Export CSV
          </Button>
          <Button variant="default" size="default" onClick={handlePrint} data-testid="button-pbc-print">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2">
              ...
              <Select value={selectedProgram} onValueChange={setSelectedProgram}>
                <SelectTrigger data-testid="select-pbc-program">
      ...
      <div className="grid gap-4 md:grid-cols-4 print:mb-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-emerald-600">{markedStudents}</div>
          </CardContent>
        </Card>
      ...
      <div className="hidden print:block print:mb-6">
        <div className="text-center border-b-2 border-gray-800 pb-4 mb-6">
          <h1 className="text-2xl font-bold mb-2">Pakistan Bar Council</h1>
                  ...
                  {filteredStudents.map((student, index) => {
                    ...
                    return (
                      <tr key={student.id} className="border-b hover:bg-muted/50 print:hover:bg-transparent">
                        ...
                        <td className="p-3 font-medium" data-testid={`pbc-roll-${student.id}`}>
                          {student.rollNumber}
                        </td>
      ...
      <Card className="border-emerald-200 bg-emerald-50/50 print:hidden">
        <CardContent className="pt-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-semibold text-emerald-900">Read-Only Access</h3>
              <p className="text-sm text-emerald-700 mt-1">
                This is a read-only report for Pakistan Bar Council. You can view, print, and export attendance data but cannot modify records.
              </p>
            </div>
          </div>
        </CardContent>
