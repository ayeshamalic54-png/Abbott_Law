...
export default function PBCDashboard() {
  ...
  const filteredAttendance = programsLoading || llbProgramNames.length === 0
    ...
    : attendance.filter(a => {
        ...
        // Only show LLB program students in PBC portal
    ...
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-3xl font-bold text-foreground" data-testid="heading-pbc-dashboard">
              Pakistan Bar Council Portal
            </h1>
      ...
      <div className="flex gap-3 flex-wrap items-center">
        <div className="relative flex-1 min-w-[250px] max-w-md">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 border border-input rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500"
            data-testid="input-pbc-search"
          />
        </div>
        <div className="flex items-center gap-2">
          ...
          <input
            ...
            data-testid="input-pbc-from-date"
          />
        </div>
        <div className="flex items-center gap-2">
          ...
          <input
            ...
            className="px-3 py-2 border border-input rounded-md text-sm"
            data-testid="input-pbc-to-date"
          />
        </div>
        <Select value={selectedProgram} onValueChange={setSelectedProgram}>
          <SelectTrigger className="w-56" data-testid="select-pbc-program">
      ...
      <div className="grid gap-4 md:grid-cols-5">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-emerald-600">{attendancePercentage}%</div>
                ...
                <tbody>
                  {filteredAttendance.map((record) => (
                    <tr key={record.id} className="border-b hover:bg-muted/50">
                      <td className="p-3 font-medium" data-testid={`pbc-roll-${record.id}`}>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-emerald-700 mt-1">
                This portal provides read-only access to student attendance records for Pakistan Bar Council monitoring and reporting purposes. 
